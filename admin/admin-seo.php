    ...
    // Function to insert or update SEO data (UPDATED to include keywords)
    function handle_seo_data($type, $seo_title, $seo_description, $seo_keywords)
    {
        global $db;
        $existing_data = fetch_seo_data($type);

        if ($existing_data) {
            $sql_update = "UPDATE seo_settings SET seo_title = ?, seo_description = ?, seo_keywords = ? WHERE type = ?";
            $stmt_update = $db->prepare($sql_update);
            // 4 strings: title, description, keywords, type
            $stmt_update->bind_param("ssss", $seo_title, $seo_description, $seo_keywords, $type);
            $stmt_update->execute();
            $stmt_update->close();
            $_SESSION['message'] = "SEO data for $type updated successfully.";
        } else {
            $sql_insert = "INSERT INTO seo_settings (type, seo_title, seo_description, seo_keywords) VALUES (?, ?, ?, ?)";
            $stmt_insert = $db->prepare($sql_insert);
            // 4 strings: type, title, description, keywords
            $stmt_insert->bind_param("ssss", $type, $seo_title, $seo_description, $seo_keywords);
            $stmt_insert->execute();
            $stmt_insert->close();
    ...
    // Handle form submissions (UPDATED to capture keywords)
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        if (isset($_POST['home'])) {
            $title = $_POST['home_title'];
            $content = $_POST['content'];
            $keywords = $_POST['home_keywords']; // Capture keywords
            $type = 'home';
            handle_seo_data($type, $title, $content, $keywords);
            header("Location: admin-seo.php");
            exit();
        } elseif (isset($_POST['about'])) {
            $title = $_POST['about_title'];
            $content = $_POST['about_content'];
            $keywords = $_POST['about_keywords']; // Capture keywords
            $type = 'about';
            handle_seo_data($type, $title, $content, $keywords);
            header("Location: admin-seo.php");
            exit();
            ...
            $keywords = $_POST['contact_keywords']; // Capture keywords
            $type = 'contact';
            handle_seo_data($type, $title, $content, $keywords);
            header("Location: admin-seo.php");
            exit();
            ...
            $keywords = $_POST['dynamic_keywords']; // Capture keywords
            handle_seo_data($type, $title, $content, $keywords);
            header("Location: admin-seo.php");
            exit();
        }
...
<ul class="collapse list-group" id="blogsMenu">
    <?php foreach ($blogs as $blog) { 
        // Unique type banayein: jaise 'blog-1', 'blog-2'
        $blog_type = 'blog-' . $blog['idblog']; 
    ?>
        <li class="list-group-item">
            <a href="#id_dynamic" class="dynamic-link"
               data-type="<?php echo htmlspecialchars($blog_type); ?>"
                                                                                            ...
                                                                                            <div class="crancy__item-group">
                                                                                                ...
                                                                                                <div class="crancy__item-form--group">
                                                                                                    <div class="row">
                                                                                                        ...
                                                                                                        <!-- Add this right after the SEO Description textarea in the Home form -->
                                                                                                        <div class="col-12">
                                                                                                            <div class="crancy__item-form--group mg-top-form-20">
                                                                                                                <label class="crancy__item-label">SEO Keywords</label>
                                                                                                                <input class="crancy__item-input" placeholder="Enter keywords separated by commas (e.g., events, medical, corporate)" type="text" value="<?php echo isset($home_data['seo_keywords']) ? htmlspecialchars($home_data['seo_keywords']) : ''; ?>" name="home_keywords">
                                                                                                            </div>
                                                                                                        </div>
                                                                                                        <div class="col-12">
                                                                                                            <div class="crancy__item-form--group mg-top-form-20">
                                                                                            ...
                                                                                            <div class="crancy__item-group">
                                                                                                ...
                                                                                                <div class="crancy__item-form--group">
                                                                                                    <div class="row">
                                                                                                        ...
                                                                                                        <!-- Add this right after the SEO Description textarea in the About form -->
                                                                                                        <div class="col-12">
                                                                                                            <div class="crancy__item-form--group mg-top-form-20">
                                                                                                                <label class="crancy__item-label">SEO Keywords</label>
                                                                                                                <input class="crancy__item-input" placeholder="Enter keywords separated by commas" type="text" value="<?php echo isset($about_data['seo_keywords']) ? htmlspecialchars($about_data['seo_keywords']) : ''; ?>" name="about_keywords">
                                                                                                            </div>
                                                                                                        </div>
                                                                                                        <div class="col-12">
                                                                                                            <div class="crancy__item-form--group mg-top-form-20">
                                                                                            ...
                                                                                            <div class="crancy__item-group">
                                                                                                ...
                                                                                                <div class="crancy__item-form--group">
                                                                                                    <div class="row">
                                                                                                        ...
                                                                                                        <!-- Add this right after the SEO Description textarea in the Visitor form -->
                                                                                                        <div class="col-12">
                                                                                                            <div class="crancy__item-form--group mg-top-form-20">
                                                                                                                <label class="crancy__item-label">SEO Keywords</label>
                                                                                                                <input class="crancy__item-input" placeholder="Enter keywords separated by commas" type="text" value="<?php echo isset($visitor_data['seo_keywords']) ? htmlspecialchars($visitor_data['seo_keywords']) : ''; ?>" name="dynamic_keywords">
                                                                                                            </div>
                                                                                                        </div>
                                                                                                        <div class="col-12">
                                                                                                            <div class="crancy__item-form--group mg-top-form-20">
                                                                                            ...
                                                                                            <div class="crancy__item-group">
                                                                                                ...
                                                                                                <div class="crancy__item-form--group">
                                                                                                    <div class="row">
                                                                                                        ...
                                                                                                        <!-- Add this right after the SEO Description textarea in the Contact form -->
                                                                                                        <div class="col-12">
                                                                                                            <div class="crancy__item-form--group mg-top-form-20">
                                                                                                                <label class="crancy__item-label">SEO Keywords</label>
                                                                                                                <input class="crancy__item-input" placeholder="Enter keywords separated by commas" type="text" value="<?php echo isset($contact_data['seo_keywords']) ? htmlspecialchars($contact_data['seo_keywords']) : ''; ?>" name="contact_keywords">
                                                                                                            </div>
                                                                                                        </div>
                                                                                                        <div class="col-12">
                                                                                                            <div class="crancy__item-form--group mg-top-form-20">
                                                                                            ...
                                                                                            <div class="crancy__item-group">
                                                                                                ...
                                                                                                <div class="crancy__item-form--group">
                                                                                                    <div class="row">
                                                                                                        ...
                                                                                                        <!-- Add this right after the SEO Description textarea in the Dynamic form -->
                                                                                                        <div class="col-12">
                                                                                                            <div class="crancy__item-form--group mg-top-form-20">
                                                                                                                <label class="crancy__item-label">SEO Keywords</label>
                                                                                                                <input class="crancy__item-input" placeholder="Enter keywords separated by commas" type="text" name="dynamic_keywords" id="dynamic_seo_keywords">
                                                                                                            </div>
                                                                                                        </div>
                                                                                                        <div class="col-12">
                                                                                                            <div class="crancy__item-form--group mg-top-form-20">
...
document.querySelectorAll('.dynamic-link').forEach(link => {
    link.addEventListener('click', function(event) {
        ...
        console.log('Fetching SEO for type:', type); // Debug log
        ...
        document.getElementById('dynamic_seo_keywords').value = '';
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.success) {
                    ...
                    document.getElementById('dynamic_seo_keywords').value = response.data.seo_keywords || '';
