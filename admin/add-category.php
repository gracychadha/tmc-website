...
if (isset($_POST['submit']))
{
    ...
    $sql = "INSERT INTO category (category_name,parent_category,status) VALUES ('$category_name','$parent_category_name','$status')";
    if ($db->query($sql) === TRUE)
    {
        $msg = "
            <div class='alert alert-success alert-dismissible fade show' role='alert' style='font-size:16px;' id='goldmessage'>
            <strong><i class='feather icon-check'></i>Thanks!</strong> a new category added Successfully
                            ...
                            <form class="contact-us" method="post" action="" enctype="multipart/form-data"
                                ...
                                <div class=" ">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                           <div class="form-group">
                                               <label for="parent_category" class="form-label">Parent Category Name</label>
                    								<?php
                                                        ...
                                                        if ($result->num_rows > 0) {
                                                            ...
                                                            while ($row = $result->fetch_assoc()) {
                                                                 echo "<option value='{$row['parent_category_name']}'>{$row['parent_category_name']}</option>";
                                                            }
