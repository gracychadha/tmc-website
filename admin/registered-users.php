                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h5 class="m-b-10">All Registered Users
                                </h5>
                            </div>
<!-- 							<ul class="breadcrumb"> -->
...
<!--                             </ul> -->
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                          <form id="deleteForm" action="delete-registered-users.php" method="post">
  ...
  <strong><i class='feather icon-check'></i>Success!</strong> Client has been Updated Successfully.
...
//                                     echo "<td><input type='checkbox' name='users_ids[]' value='$encoded_id'></td>";
                                
                                
//                                     echo "<td> $count</td>";
//                                     echo "<td>" . $row['1'] . "</td>";
//                                     echo "<td>" . '<img src="client/' . $row['2'] . '" style="width:150px;height:150px" />' . "</td>";
//                                     echo "<td>";
//                                     if ($row['3'] == 1) {
//                                         echo "Enable";
//                                     } else {
...
//                                         </a>
//                                         <a href='delete-client.php?id=$encoded_id' class='btn btn-danger' onclick='return confirm(\"Are you sure you want to delete this client?\")'>
