...
<!--                             </ul> -->
                ...
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                         ...
                         <form id="deleteForm" action="delete-menu.php" method="post">
  ...
  <strong><i class='feather icon-check'></i>Success!</strong> Menu has been Updated Successfully.
  ...
  <strong>Error!</strong> Menu has been not Updated
  <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
    <span aria-hidden='true'>&times;</span>
  </button>
</div> ";
                                ...
                                while ($row = mysqli_fetch_row($result)) {
                                    ...
                                    echo "<td><input type='checkbox' name='menu_ids[]' value='$encoded_id'></td>";
                                    ...
                                    $truncatedDesc = strlen($row['3']) > 20 ? substr($row['3'], 0, 20) . ". . ." : $row['3'];
                                    ...
                                    echo "<td>
                                        <a href='edit-menu.php?id=$res' class='btn btn-warning'>
                                            <i class='feather icon-edit'></i> Edit
                                        </a>
                                        <a href='delete-menu.php?id=$res' class='btn btn-danger' onclick='return confirm(\"Are you sure you want to delete this menu?\")'>
