                ...
                <div class="card">
                    <div class="card-header d-flex align-items-center justify-content-between flex-wrap pb-0">
                        ...
                        <div class="d-flex align-items-center flex-wrap">
                            ...
                            $filterConfig = [
                                'page_type'    => 'blog',
                                'table_id'     => 'datatable',
                                'show_filters' => ['name', 'status', 'date_range'],
                                'sort_enabled' => true,
                            ];
                    ...
                    <div class="card-body p-0 py-3">
                        <div class="custom-datatable-filter table-responsive">
                            <table class="table datatable" data-name-col="1" data-status-col="5" data-date-col="6">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td><img src='<?php echo $imagePath; ?>' alt='Blog Image' class="tmc-img-preview-lg"></td>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="d-flex align-items-center upload-pic flex-wrap row-gap-3">
                                        <div class="d-flex align-items-center justify-content-center avatar avatar-xxl border border-dashed me-2 flex-shrink-0 text-dark frames">
                                            <img id="edit-image-preview" src="" alt="Blog Image" class="tmc-img-preview-lg">
                                        </div>
                                        <div class="profile-upload">
                                            <div class="profile-uploader d-flex align-items-center">
                                                <div class="drag-upload-btn mb-3">
