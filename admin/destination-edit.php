        ...
        <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
          <span aria-hidden='true'>&times;</span>
            ...
            if ($file_size < 2 * 1024 * 1024) {
                ...
                $query = "SELECT * FROM destination WHERE 	dest_id='"  . $de . "'";
                $result = mysqli_query($db, $query);
                $row = mysqli_fetch_row($result);
                $f = $row['6'];
                $old = "destination/" . $f; // Path to the old image
                unlink($old);
                move_uploaded_file($temp_name, $upload_directory . $unique_filename);
                mysqli_query($db, "UPDATE destination set dest_name ='$dest', menu='$menu',details='$details',weather='$weather',location='$map',image='$unique_filename',status='$status' WHERE dest_id='"  . $de . "'");
                $stat = 1;
                $re = base64_encode($stat);
                echo ("<SCRIPT LANGUAGE='JavaScript'>
    window.location.href='manage-destination.php?status=$re';
    </SCRIPT>");
            } else {
                $msg = "<div class='alert alert-danger alert-dismissible fade show' role='alert' style='font-size:16px;' id='goldmessage'>
        ...
        mysqli_select_db($db, DB_NAME);
        mysqli_query($db, "UPDATE destination set dest_name ='$dest', menu='$menu',details='$details',weather='$weather',location='$map',status='$status' WHERE dest_id='"  . $de . "'");
        $stat = 1;
        $re = base64_encode($stat);
        echo ("<SCRIPT LANGUAGE='JavaScript'>
    window.location.href='manage-destination.php?status=$re';
...
$result = mysqli_query($db, "SELECT * FROM destination WHERE 	dest_id='"  . $de . "'");
$row = mysqli_fetch_row($result);
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h5 class="m-b-10">Edit Destination
                            </div>
                                ...
                                <div class=" ">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group"> Destination Name
                                                <label class="sr-only control-label" for="name">Category Name<span
                                                        class=" ">
                                                    </span></label>
                                                <input id="category" name="dest" type="text"
                                                    placeholder=" Enter the Destination Name"
                                                    class="form-control input-md" required
                                                    oninvalid="this.setCustomValidity('Please Enter Destination Name')"
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                            <div class="form-group"> Add Details
                                                ...
                                                <textarea class="form-control" rows="2" cols="45" name="editor1"
                                                    id="editor1"><?php echo $row['3']; ?></textarea>
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">Map
                                                ...
                                                <select class="form-control" name="map" required>
                                                    ...
                                                    <option value="<?php echo $row['5']; ?>"><?php echo $row['5']; ?>
                                                    </option>
                                                    <option value="yes">Yes</option>
                                                    <option value="no">No</option>
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <?php echo  '<img src="destination/' . $row['6'] . '" style="width:300px;height:120px;" class="img-thumbnail responsive" />'; ?>
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                            ...
                                            <button type="submit" class="btn btn-secondary" name="submit" id="submit">
                                                <i class="feather icon-save"></i>&nbsp; Update Destination
                                            </button>
                                        </div>
                                    </div>
                                </div>
