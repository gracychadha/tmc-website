...
$query = "SELECT * FROM tender where status=2";
  ...
  <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
    <span aria-hidden='true'>&times;</span>
                                ...
                                while ($row = mysqli_fetch_row($result)) {
                                    ...
                                    echo "<td>" . $row['2'] . "<br/> " . "<span style='color:red;'> " . $row['5'] . "</span>" . "<br/>" . "<span style='color:green;'> " . $row['4'] . "</span>" . "<br/>" .  "<span style='color:orange;'> " . $row['3'] . "</span>" . "</td>";
                                    echo "<td>" . $row['11'] . "</td>";
                                    echo "<td>" . $row['6'] . "</td>";
                                    ...
                                    echo "<td>" . "<span class='btn btn-success'>" . $row[17] . "</span>" . "<br/><br/>" . "Aloted Date :" . "<br/>" . $row['15'] . "<br/>" . '<a href="../login/tender/' . $row['9'] . '"  target="_blank"/>View file </a>' . "</td>";


                                    $res = $row[0];
                                    $res = base64_encode($res);
                                    echo "<td>  <a href='alot-tender-update.php?id=$res'><button type='button' class='btn btn-warning'><i class='feather icon-edit'></i> &nbsp;Alot</button></a>  &nbsp;   <a href='#' id='" . $row['0'] . "'class='delbutton btn btn-danger' title='Click To Delete'> <i class='feather icon-trash'></i>  &nbsp; delete</a></td>";
