...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['delete-form']) && isset($_POST['id'])) {
        $ids = $_POST['id'];
        $id_array = array_map('intval', explode(',', $ids));
        $placeholders = implode(',', array_fill(0, count($id_array), '?'));
        $sql_delete = "DELETE FROM contacts WHERE id IN ($placeholders)";
        ...
        $stmt->close();
        header("Location: portfolio-contacts.php");
        exit();
    }
    // Process Edit
    elseif (isset($_POST['action']) && $_POST['action'] === 'edit-id' && isset($_POST['id'])) {
        $id = intval($_POST['id']);
        ...
        $sql_update = "UPDATE contacts SET name = ?, phone = ?, email = ?, message = ? WHERE id = ?";
    ...
    $id = intval($_GET['id']);
    $sql_fetch = "SELECT * FROM contacts WHERE id = ?";
...
<head>
    ...
    <title>Portfolio Contact Messages - Tee Mac Corporation</title>
...
<body>
    ...
    <div class="main-wrapper">
            ...
            <div class="content">
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between mb-3">
                    ...
                    <div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
                        <div class="pe-1 mb-2">
                            <a href="portfolio-contacts.php" class="btn btn-outline-light bg-white btn-icon me-1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Refresh">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                <td>
                                                    <div class="form-check form-check-md">
                                                        <input class="form-check-input delete-checkbox" type="checkbox" value="<?php echo $rowcontact['id']; ?>">
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a href="#" class="btn btn-outline-light bg-white btn-icon d-flex align-items-center justify-content-center rounded-circle edit-btn p-0 me-2" data-bs-toggle="modal"
                                                            data-id="<?php echo $rowcontact['id']; ?>"
                                                        ...
                                                        <a href="#" class="btn btn-outline-light bg-white btn-icon d-flex align-items-center justify-content-center rounded-circle p-0 me-3 delete-btn" data-bs-toggle="modal" data-bs-target="#delete-modal" data-id="<?php echo $rowcontact['id']; ?>"><i class="ti ti-trash-x text-danger"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                    <?php
        ...
        <div class="modal fade" id="edit_role" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form action="portfolio-contacts.php" method="POST">
        ...
        <div class="modal fade" id="delete-modal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <form method="POST" action="portfolio-contacts.php">
