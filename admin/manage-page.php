...
<!--                             </ul> -->
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                          <form id="deleteForm" action="delete-page.php" method="post">
  ...
  <strong><i class='feather icon-check'></i>Success!</strong> Page has been Updated Successfully.
  ...
  <strong>Error!</strong> Page has been not Updated
  <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
    <span aria-hidden='true'>&times;</span>
  </button>
</div> ";
                                ...
                                while ($row = mysqli_fetch_row($result)) {
                                    ...
                                    echo "<td><input type='checkbox' name='page_ids[]' value='$encoded_id'></td>";
                                    ...
                                    echo "<td>
                                        <a href='edit-page.php?id=$res' class='btn btn-warning'>
                                            <i class='feather icon-edit'></i> Edit
                                        </a>
                                        <a href='delete-page.php?id=$res' class='btn btn-danger' onclick='return confirm(\"Are you sure you want to delete this page?\")'>
