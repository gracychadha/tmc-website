...
// ✅ FIX 1: Initialize ALL variables at the very top with defaults
$site_key = '';
$secret_key = '';
$faviconPath = '';
$backpanelLogoPath = '';
$blackImagePath = '';  // This was causing the error
$helpdesk = '';
...
// ✅ FIX 2: Fetch system settings - variables already initialized above
...
if ($stmt = $db->prepare($sqlfav)) {
    ...
    if ($stmt->fetch()) {
        ...
        $blackImagePath = "logo/" . $black_image;  // Now this will always be defined
    }
    $stmt->close();
} else {
    ...
    <style>
        ...
        *::after {
        ...
        .bg-scene::before {
            ...
            position: absolute;
            inset: 0;
            /* ✅ FIX 3: Safe background image with fallback */
            background: <?php echo !empty($blackImagePath) ? "url('" . htmlspecialchars($blackImagePath) . "') center/cover no-repeat" : "linear-gradient(135deg, #0a0a1a 0%, #1a1a2e 100%)"; ?>;
        ...
        .particle:nth-child(1) { left: 10%; animation-duration: 18s; width: 2px; height: 2px; }
        .particle:nth-child(2) { left: 22%; animation-duration: 22s; animation-delay: 3s; }
        .particle:nth-child(3) { left: 38%; animation-duration: 16s; animation-delay: 6s; width: 4px; height: 4px; opacity: 0.6; }
        .particle:nth-child(4) { left: 52%; animation-duration: 20s; animation-delay: 2s; }
        .particle:nth-child(5) { left: 68%; animation-duration: 24s; animation-delay: 8s; width: 2px; height: 2px; }
        .particle:nth-child(6) { left: 78%; animation-duration: 17s; animation-delay: 5s; }
        .particle:nth-child(7) { left: 90%; animation-duration: 21s; animation-delay: 1s; width: 4px; height: 4px; opacity: 0.5; }
        .particle:nth-child(8) { left: 45%; animation-duration: 19s; animation-delay: 7s; }
        ...
        @keyframes iconPulse {
            0%, 100% { box-shadow: 0 12px 35px rgba(212, 175, 55, 0.3); }
            ...
            <div class="login-container">
                ...
                <div class="left-panel">
                    <div class="left-content">
                        <?php if (!empty($blackImagePath)): ?>
                            <img src="<?php echo htmlspecialchars($blackImagePath); ?>" alt="TMC" class="brand-logo" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                        <?php endif; ?>
                        <h2 style="<?php echo !empty($blackImagePath) ? 'display:none;' : ''; ?>"><span>Tee Mac</span> Corporation</h2>
                ...
                <div class="right-panel">
                    ...
                    <form action="index.php" method="POST" style="width: 100%;">
                        ...
                        <div class="captcha-wrap">
                            <div class="cf-turnstile" data-sitekey="<?php echo htmlspecialchars($site_key); ?>" data-callback="enableSubmitButton"></div>
                        </div>
                    ...
                    <div class="helpdesk-bar">
                        ...
                        <span>HelpDesk: <strong><?php echo htmlspecialchars($helpdesk); ?></strong></span>
                    </div>
                </div>
