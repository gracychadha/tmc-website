...
if (isset($_GET['id'])) {
    ...
    $query = "SELECT * FROM vertical_ad WHERE ad_id = $advtId";
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        echo "Vertical Advertisement not found!";
        exit;
    }
} else {
...
if (isset($_POST['submit'])) {
    ...
    if ($_FILES["uploaded_file"]["size"] > 0) {
        ...
        if (!in_array($file_type, $allowed_types)) {
            ...
            if ($file_size < 5 * 1024 * 1024) {
                ...
                $updateQuery = "UPDATE vertical_ad SET ad_title = '$title', image = '$unique_filename', status= '$status' WHERE ad_id = $advtId";
        ...
        $updateQuery = "UPDATE vertical_ad SET ad_title = '$title', status= '$status' WHERE ad_id = $advtId";
        mysqli_query($db, $updateQuery);
    }
    ...
    echo ("<SCRIPT LANGUAGE='JavaScript'>window.location.href='manage-vertical-advt.php?status=$re';</SCRIPT>");
}
?>
...
<head>
    <title>Update Vertical Advertisement</title>
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h5 class="m-b-10">Update Vertical Advertisement</h5>
                            </div>
<!--                              <ul class="breadcrumb"> -->
                                ...
                                <div class="row">
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-6">
                                        <div class="form-group">
                                           <label for="advt_title" class="form-label">Vertical Advt Title <span class="red-text">*</span></label>
                                   ...
                                   <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
    									<div class="form-group">
        									<label for="uploaded_file" class="form-label">Vertical Advt Image</label>
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                         <button type="submit" class="btn btn-secondary" name="submit" id="submit">
                                             <i class="feather icon-save"></i>&nbsp; Update Vertical Advt
                                         </button>
                                   </div>
                            </form>
                        </div>
