...
if (isset($_POST['submit'])) {
    ...
    if (!in_array($video_file_type, $allowed_video_types)) {
        ...
        if ($video_file_size < 100 * 1024 * 1024) {
            ...
            $category_name = mysqli_real_escape_string($db, $category); // Ensure safe usage in the SQL query
            ...
            if ($row = mysqli_fetch_assoc($result)) {
                ...
                $query = "INSERT INTO videos (category_id, category_name, video_title, video_description, video_filename, upload_date, thumbnail_url, status)
                          VALUES ('$category_id', '$category_name', '$title', '$description', '$unique_video_filename', '$uploadDate', '$unique_image_filename', '$status')";
                                ...
                                <div class=" ">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                            <div class="form-group">
												<label for="video" class="form-label">Select Video <span class="red-text">*</span></label>
