...
if (isset($_POST['submit']))
{
    ...
    $sql = "INSERT INTO statistics (our_achievements, performance_rating, our_clients, our_projects, our_experience, our_overseas_engagements)
            VALUES ('$NewAchievements', '$NewPerformance', '$NewClients', '$NewProjects', '$NewExperience', '$NewEngagements')";
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h5 class="m-b-10">Add Statistics
                                </h5>
                            </div>
<!--                             <ul class="breadcrumb"> -->
                                      ...
                                      <div class="row">
                                           <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                              <div class="form-group">
                    						     ...
                    						     <input type="text" name="achievements" class="form-control" placeholder="Enter the number of achievements">
                                              </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                              <div class="form-group">
                                                 <label for="performance" class="form-label">Performance Rating</label>
                    						     <input type="text" name="performance" class="form-control" placeholder="Enter Performance rating">
                                              </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                              <div class="form-group">
                                                 <label for="clients" class="form-label">Number of Clients <span class="red-text">*</span></label>
                    						     <input type="text" name="clients" class="form-control" placeholder="Enter number of clients" required>
                                              </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                              <div class="form-group">
                                                 <label for="projects" class="form-label">Number of Projects <span class="red-text">*</span></label>
                    						     <input type="text" name="projects" class="form-control" placeholder="Enter number of projects" required>
                                              </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                              <div class="form-group">
                                                 <label for="experience" class="form-label">Year's of Field Experience</label>
                    						     <input type="text" name="experience" class="form-control" placeholder="Enter years of experience">
                                              </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                              <div class="form-group">
                                                 <label for="engagements" class="form-label"> Number of Overseas Engagements</label>
                    						     <input type="text" name="engagements" class="form-control" placeholder="Enter number of engagements">
                                              </div>
                                            </div>
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                            <button type="submit" class="btn btn-secondary" name="submit" id="submit">
                                                <i class="feather icon-save"></i>&nbsp; Add Statistics
                                            </button>
                                        </div>
                                    </div>
                                </div>
