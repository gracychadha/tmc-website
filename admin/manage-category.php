                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h5 class="m-b-10">All Categories
                            </div>
<!--                             <ul class="breadcrumb"> -->
...
<!--                             </ul> -->
  ...
  <strong><i class='feather icon-check'></i>Success!</strong> Category has been Updated Successfully.
  ...
  <strong>Error!</strong> Category has been not Updated
  <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
    <span aria-hidden='true'>&times;</span>
  </button>
</div> ";
                            ...
                            while ($row = mysqli_fetch_row($result)) {
                                ...
                                echo "<td>" . $row[1] . "</td>";
                                echo "<td>" . $row[2] . "</td>";
                                echo "<td>" . ($row[3] == 1 ? "Enable" : "Disable") . "</td>";
                                echo "<td>
                                        <a href='edit-category.php?id=$encoded_id' class='btn btn-warning'>
                                            <i class='feather icon-edit'></i> Edit
                                        </a>
                                        <a href='delete-category.php?id=$encoded_id' class='btn btn-danger' onclick='return confirm(\"Are you sure you want to delete this category?\")'>
