        ...
        <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
          <span aria-hidden='true'>&times;</span>
            ...
            if ($file_size < 2 * 1024 * 1024) {
                ...
                $query = "SELECT * FROM blog WHERE blog_id='"  . $de . "'";
                ...
                mysqli_query($db, "UPDATE blog set title ='$title', category='$category',details='$details',publish='$publish',date='$date',image='$unique_filename',status='$status' WHERE blog_id='"  . $de . "'");
                $stat = 1;
                $re = base64_encode($stat);
                echo ("<SCRIPT LANGUAGE='JavaScript'>
    window.location.href='view-blog.php?status=$re';
    </SCRIPT>");
            } else {
                $msg = "<div class='alert alert-danger alert-dismissible fade show' role='alert' style='font-size:16px;' id='goldmessage'>
        ...
        mysqli_select_db($db, DB_NAME);
        mysqli_query($db, "UPDATE blog set title ='$title', category='$category',details='$details',publish='$publish',date='$date',status='$status' WHERE blog_id='"  . $de . "'");
        $stat = 1;
        $re = base64_encode($stat);
        echo ("<SCRIPT LANGUAGE='JavaScript'>
    window.location.href='view-blog.php?status=$re';
...
$result = mysqli_query($db, "SELECT * FROM blog WHERE 	blog_id='"  . $de . "'");
$row = mysqli_fetch_row($result);
                                    ...
                                    <div class="row">
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group"> Title
                                                ...
                                                <input id="category" name="title" type="text"
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <?php echo  '<img src="blog/' . $row['4'] . '" style="width:300px;height:120px;" class="img-thumbnail responsive" />'; ?>
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                            ...
                                            <button type="submit" class="btn btn-secondary" name="submit" id="submit">
                                                <i class="feather icon-save"></i>&nbsp; Update Blog
                                            </button>
                                        </div>
                                    </div>
                                </div>
