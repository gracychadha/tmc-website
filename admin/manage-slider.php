...
<!--                             </ul> -->
                ...
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                         ...
                         <form id="deleteForm" action="delete-slider.php" method="post">
  ...
  <strong><i class='feather icon-check'></i>Success!</strong> Slider has been Updated Successfully.
  ...
  <strong>Error!</strong> Slider has been not Updated
  <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
    <span aria-hidden='true'>&times;</span>
  </button>
</div> ";
                                ...
                                <?php
                                    ...
                                    while ($row = mysqli_fetch_row($result)) {
                                        ...
                                        echo "<td><input type='checkbox' name='slider_ids[]' value='$encoded_id'></td>";
                                        ...
                                        echo "<td>" . '<img src="image_slider/' . $row['3'] . '" style="width:150px;height:150px" />' . "</td>";
    
                                        echo "<td>";
                                        echo $row['4'] == 1 ? "Enable" : "Disable";
                                        echo "</td>";

                                     
                                        echo "<td>
                                            <a href='edit-slider.php?id=$encoded_id' class='btn btn-warning'>
                                                <i class='feather icon-edit'></i> Edit
                                            </a>
                                            <a href='delete-slider.php?id=$encoded_id' class='btn btn-danger' onclick='return confirm(\"Are you sure you want to delete this slider?\")'>
