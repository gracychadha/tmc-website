...
$d = base64_decode($en);
$query = "SELECT email FROM tender WHERE id='" . $d . "'";
...
if (isset($_POST['submit'])) {
    ...
    $row = mysqli_fetch_row($result);
    $email = $row[0];
    mysqli_query($db, "UPDATE tender set alloted ='$user', reminder='$days', sent_date='$sent',status='$status',sent_date='$sent' WHERE id='"  . $d . "'");
    $stat = 1;
    ...
    $mail->Password = "pnpkvipplsdsafpv";
    ...
    $mail->Body =  "<p> Dear user, <br/>" .
        "The Tender has been alloted Kindly. Kindly enter into your login panel and see the details<br/><br/>
...
$result = mysqli_query($db, "SELECT * FROM tender WHERE id='"  . $d . "'");
$row = mysqli_fetch_row($result);
