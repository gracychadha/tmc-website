...
if (isset($_POST['submit'])) {
    ...
    if (!in_array($file_type, $allowed_types)) {
        ...
        if ($file_size < 2 * 1024 * 1024) {
            ...
            $query = "insert into  slider (title,description,image,status) values('$title','$details','$unique_filename','$status')";
            mysqli_query($db, $query);
            
            $msg = "
            <div class='alert alert-success alert-dismissible fade show' role='alert' style='font-size:16px;' id='goldmessage'>
            <strong><i class='feather icon-check'></i>Thanks!</strong>Add slider image Successfully
            <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
              <span aria-hidden='true'>&times;</span>
            </button>
          </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h5 class="m-b-10"> Add Image Slider
                                </h5>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class=" ">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group"> Slider Title <span class="red-text">*</span>
                                                <label class="sr-only control-label" for="name">Slider Title<span
                                                        class=" ">
                                                    </span></label>
                                               		<input id="category" name="title" type="text"
                                                    placeholder=" Enter the Slider Title" class="form-control input-md"
                                                    required
                                        ...
                                        <!-- Modal end -->
                                         ...
                                         <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                            <div class="form-group"> Slider Details <span class="red-text">*</span>
                                                <label class="sr-only control-label" for="name">Slider Details<span class=" ">
                                                    </span></label>
                                                <textarea class="form-control" rows="2" cols="45" name="details"
                                                    ></textarea>
                                            </div>
                                        </div>
                                        <!-- Text input-->
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                            <button type="submit" class="btn btn-secondary" name="submit" id="submit">
                                                <i class="feather icon-save"></i>&nbsp; Add Slider
                                            </button>
                                        </div>
                                    </div>
                                </div>
