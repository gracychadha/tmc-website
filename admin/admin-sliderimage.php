...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['add-form'])) {
        ...
        if (isset($_FILES['featured_image']) && $_FILES['featured_image']['error'] == 0) {
            ...
            if ($check !== false) {
                if (move_uploaded_file($_FILES["featured_image"]["tmp_name"], $targetFile)) {
                    ...
                    header('Location: admin-sliderimage.php');
                    exit();
                }
            } else {
        ...
        $stmt = $db->prepare("INSERT INTO sliders (image, status, created_at) VALUES (?, ?, ?)");
    ...
    <div class="main-wrapper">
            ...
            <div class="content">
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between mb-3">
                    ...
                    <div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
                        ...
                        <div class="mb-2">
                            <a href="#" class="btn btn-primary d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#add_slider"><i class="ti ti-square-rounded-plus me-2"></i>Add Slider</a>
                        </div>
                    </div>
                </div>
                <!-- /Page Header -->
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                <td>
                                                    <div class="form-check form-check-md">
                                                        <input class="form-check-input delete-checkbox" type="checkbox" value="<?php echo $rowslider['idslider']; ?>">
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a href="#" class="btn btn-outline-light bg-white btn-icon edit-btn d-flex align-items-center justify-content-center rounded-circle p-0 me-2"
                                                            ...
                                                            data-bs-toggle="modal" data-bs-target="#edit_slider"><i class="ti ti-edit-circle text-primary"></i></a>
                                                        <a href="#" class="btn btn-outline-light bg-white btn-icon d-flex align-items-center justify-content-center delete-btn rounded-circle p-0 me-3" data-id="<?php echo $rowslider['idslider']; ?>" data-bs-toggle="modal" data-bs-target="#delete-modal"><i class="ti ti-trash-x text-danger"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                    <?php }
        ...
        <div class="modal fade" id="add_slider">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    ...
                    <form action="admin-sliderimage.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal fade" id="edit_slider" tabindex="-1" aria-labelledby="edit_sliderLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    ...
                    <form id="sliderForm" action="admin-sliderimage.php" method="POST" enctype="multipart/form-data">
                        <div class="modal-body">
                            <div class="row">
        ...
        <div class="modal fade" id="delete-modal">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <form method="POST" action="admin-sliderimage.php">
