...
<!--                             </ul> -->
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                          <form id="deleteForm" action="delete-services.php" method="post">
  ...
  <strong><i class='feather icon-check'></i>Success!</strong> Service has been Updated Successfully.
    ...
    <span aria-hidden='true'>&times;</span>
                                ...
                                <?php
                                    ...
                                    while ($row = mysqli_fetch_row($result)) {
                                        ...
                                        echo "<td><input type='checkbox' name='services_ids[]' value='$encoded_id'></td>";
                                        ...
                                        echo "<td>" . '<img src="services/' . $row['3'] . '" style="width:150px;height:150px" />' . "</td>";
                                        ...
                                        echo "<td>
                                            <a href='edit-services.php?id=$encoded_id' class='btn btn-warning'>
                                                <i class='feather icon-edit'></i> Edit
                                            </a>
                                            <a href='delete-services.php?id=$encoded_id' class='btn btn-danger' onclick='return confirm(\"Are you sure you want to delete this Service?\")'>
