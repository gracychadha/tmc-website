                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h5 class="m-b-10">All Testimonials
                                </h5>
                            </div>
<!-- 							<ul class="breadcrumb"> -->
...
<!--                             </ul> -->
                ...
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                          ...
                          <form id="deleteForm" action="delete-testimonials.php" method="post">
  ...
  <strong><i class='feather icon-check'></i>Success!</strong> Testimonial has been Updated Successfully.
  ...
  <strong>Error!</strong> Testimonial has been not Updated
  <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
    <span aria-hidden='true'>&times;</span>
  </button>
</div> ";
                                ...
                                while ($row = mysqli_fetch_row($result)) {
                                    ...
                                    echo "<td><input type='checkbox' name='testimonial_ids[]' value='$encoded_id'></td>";
                                    ...
                                    echo "<td>" . '<img src="testimonial/' . $row['4'] . '" style="width:150px;height:150px; border-radius:50%;" class="img img-circle" /> ' . "</td>";
                                    ...
                                    echo "<td>
                                        <a href='edit-testimonials.php?id=$encoded_id' class='btn btn-warning'>
                                            <i class='feather icon-edit'></i> Edit
                                        </a>
                                        <a href='delete-testimonials.php?id=$encoded_id' class='btn btn-danger' onclick='return confirm(\"Are you sure you want to delete this testimonial?\")'>
